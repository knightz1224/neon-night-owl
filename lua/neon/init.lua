...
local function set_groups()
    local groups = {
        ...
        LspReferenceText =  {bg = c.cyan_blue, style = "bold"}, -- used for highlighting "text" references
        LspReferenceRead =  {bg = c.cyan_blue, style = "bold"}, -- used for highlighting "read" references
        LspReferenceWrite = {bg = c.cyan_blue, style = "bold"}, -- used for highlighting "write" references
