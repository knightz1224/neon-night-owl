...
local function set_groups()
    local groups = {
        ...
        Normal = {fg = "#d6deeb", bg = "#011627"}, -- normal text and background color
        SignColumn = {fg = "NONE", bg = "#011627"},
        EndOfBuffer = {fg = c.disabled}, -- ~ lines at the end of a buffer
        NormalFloat = {fg = "#d6deeb", bg = "#011627"}, -- normal text and background color for floating windows
        ColorColumn = {fg = "#222222", bg = "NONE"}, --  used for the columns set with 'colorcolumn'
        Conceal = {fg = "#eeeeee"}, -- placeholder characters substituted for concealed text (see 'conceallevel')
        Cursor = {fg = "#80a4c2", bg = "NONE", style = "reverse"}, -- the character under the cursor
        CursorIM = {fg = "#80a4c2", bg = "NONE", style = "reverse"}, -- like Cursor, but used when in IME mode
        Directory = {fg = "#82aaff", bg = "NONE", style = cfg.bold}, -- directory names (and other special names in listings)
        DiffAdd = {fg = "#addb67", bg = "NONE", style = "reverse"}, -- diff mode: Added line
        DiffChange = {fg = "#ecc48d", bg = "NONE", style = "reverse"}, --  diff mode: Changed line
        DiffDelete = {fg = "#ff5874", bg = "NONE", style = "reverse"}, -- diff mode: Deleted line
        DiffText = {fg = "#011627", bg = "NONE", style = "reverse"}, -- diff mode: Changed text within a changed line
        ErrorMsg = {fg = "#EF5350"}, -- error messages
        Folded = {fg = "#777777", "NONE", style = "italic"},
        FoldColumn = {fg = "#333333"},
        IncSearch = {style = "reverse"},
        LineNr = {fg = "#444444", bg = "#011627"},
        CursorLineNr = {fg = "#aaaaaa", bg = "#112630"},
        MatchParen = {fg = c.red, style = "underline,bold"},
        ModeMsg = {fg = c.cyan, style = cfg.bold},
        MoreMsg = {fg = c.cyan, style = cfg.bold},
        NonText = {fg = "#011627"},
        Pmenu = {fg = "#d6deeb", bg = "#2d2c5d"},
        PmenuSel = {bg = "#c792ea", style = "bold"},
        PmenuSbar = {fg = "#d6deeb", bg = "#011627"},
        PmenuThumb = {fg = "#d6deeb", bg = "#eeeeee"},
        Question = {fg = c.green, style = cfg.bold},
        QuickFixLine = {fg = c.blue, bg = "#011627", style = "bold,italic"},
        qfLineNr = {fg = c.blue, bg = "#011627"},
        Search = {style = "reverse"},
        SpecialKey = {fg = "#011627"},
        SpellBad = {fg = c.red, bg = "NONE", style = "italic,undercurl"},
        SpellCap = {fg = c.blue, bg = "NONE", style = "italic,undercurl"},
        SpellLocal = {fg = c.cyan, bg = "NONE", style = "italic,undercurl"},
        SpellRare = {fg = c.cyan, bg = "NONE", style = "italic,undercurl"},
        StatusLine = {fg = c.blue, bg = "#011627"},
        StatusLineNC = {fg = "#eeeeee"},
        StatusLineTerm = {fg = "#d6deeb", bg = "#011627"},
        StatusLineTermNC = {fg = "#d6deeb", bg = "#011627"},
        TabLineFill = {fg = "#d6deeb"},
        TablineSel = {fg = "#011627", bg = c.blue},
        Tabline = {fg = "#eeeeee"},
        Title = {fg = c.cyan, bg = "NONE", style = cfg.bold},
        Visual = {fg = "NONE", style = "reverse"},
        VisualNOS = {fg = "NONE", style = "reverse"},
        WarningMsg = {fg = c.orange, style = cfg.bold},
        WildMenu = {fg = "#011627", bg = c.blue, style = "bold"},
        CursorColumn = {fg = "NONE", bg = "#d6deeb"},
        CursorLine = {fg = "NONE", bg = "#112630"},
        ToolbarLine = {fg = "#d6deeb", bg = "#011627"},
        ToolbarButton = {fg = "#d6deeb", bg = "NONE", style = "bold"},
        NormalMode = {fg = c.cyan, bg = "NONE", style = "reverse"},
        InsertMode = {fg = c.green, bg = "NONE", style = "reverse"},
        ReplacelMode = {fg = c.red, bg = "NONE", style = "reverse"},
        VisualMode = {fg = c.cyan, bg = "NONE", style = "reverse"},
        VertSplit = {fg = "#eeeeee"},
        CommandMode = {fg = "#eeeeee", bg = "NONE", style = "reverse"},
        Warnings = {fg = c.orange},
        healthError = {fg = c.red},
        healthSuccess = {fg = c.green},
        healthWarning = {fg = c.orange},
        --common
        Type = {fg = "#addb67"}, -- int, long, char, etc.
        StorageClass = {fg = c.cyan}, -- static, register, volatile, etc.
        Structure = {fg = c.orange}, -- struct, union, enum, etc.
        Constant = {fg = "#addb67"}, -- any constant
        Comment = {fg = "#eeeeee", bg = "NONE", style = cfg.italic_comment},
        Conditional = {fg = c.blue, bg = "NONE", style = cfg.italic_keyword}, -- italic if, then, else, endif, switch, etc.
        Keyword = {fg = c.blue, bg = "NONE", style = cfg.italic_keyword}, -- italic for, do, while, etc.
        Repeat = {fg = c.orange, bg = "NONE", style = cfg.italic_keyword}, -- italic any other keyword
        Boolean = {fg = c.blue_alt, bg = "NONE", style = cfg.italic_boolean}, -- true , false
        Function = {fg = c.blue, bg = "NONE", style = cfg.italic_function .. cfg.bold},
        Identifier = {fg = c.blue, bg = "NONE", style = cfg.italic_variable}, -- any variable name
        String = {fg = c.green, bg = "NONE"}, -- Any string
        ...
        Exception = {fg = "#addb67"}, -- try, catch, throw
        ...
        Special = {fg = c.blue, bg = "NONE", style = "italic"}, -- any special symbol
        ...
        Underlined = {fg = c.cyan, bg = "NONE", style = "underline"}, -- text that stands out, HTML links
        Ignore = {fg = "#eeeeee"}, -- left blank, hidden
        Error = {fg = c.red, bg = "NONE", style = "bold,underline"}, -- any erroneous construct
        Todo = {fg = c.cyan, bg = "NONE", style = "bold,italic"}, -- anything that needs extra attention; mostly the keywords TODO FIXME and XXX
        -- HTML
        htmlArg = {fg = c.orange},
        htmlBold = {fg = c.orange, bg = "NONE", style = "bold"},
        htmlEndTag = {fg = "#d6deeb"},
        htmlstyle = {fg = c.cyan, bg = "NONE", style = "italic"},
        ...
        markdownHeadingRule = {fg = "#eeeeee"},
        markdownId = {fg = c.cyan},
        markdownIdDeclaration = {fg = c.blue},
        markdownIdDelimiter = {fg = c.cyan},
        markdownstyle = {fg = c.cyan, bg = "NONE", style = "italic"},
        markdownLinkDelimiter = {fg = c.cyan},
        markdownLinkText = {fg = c.blue},
        markdownListMarker = {fg = c.red},
        markdownOrderedListMarker = {fg = c.red},
        markdownRule = {fg = "#eeeeee"},
        markdownUrl = {fg = c.cyan, bg = "NONE", style = "underline"},
        markdownBlockquote = {fg = "#eeeeee"},
        markdownBold = {fg = c.orange, bg = "NONE", style = "bold"},
        markdownCode = {fg = c.purple, bg = "#011627"},
        ...
        TSComment = {fg = "#eeeeee", bg = "NONE", style = cfg.italic_comment}, -- For comment blocks.
        ...
        TSBoolean = {fg = c.orange, bg = "NONE", style = cfg.italic_boolean}, -- true or false
        ...
        TSParameterReference = {fg = "#d6deeb"}, -- For references to parameters of a function.
        TSProperty = {fg = c.violet}, -- Same as `TSField`.
        TSPunctDelimiter = {fg = "#d6deeb"}, -- For delimiters ie: `.`
        ...
        TSUnderline = {fg = "#d6deeb", bg = "NONE", style = "underline"}, -- For text to be represented with an underline.
        TSStrike = {}, -- For strikethrough text.
        TSTitle = {fg = "#d6deeb", bg = "NONE", style = "bold"}, -- Text that is part of a title.
        TSLiteral = {fg = "#d6deeb"}, -- Literal text.
        ...
        LspReferenceText = {fg = "#d6deeb", bg = c.purple}, -- used for highlighting "text" references
        LspReferenceRead = {fg = "#d6deeb", bg = c.purple}, -- used for highlighting "read" references
        LspReferenceWrite = {fg = "#d6deeb", bg = c.purple}, -- used for highlighting "write" references
        -- Plugins highlight groups
        -- LspTrouble
        LspTroubleText = {fg = "#011627"},
        LspTroubleCount = {fg = c.purple, bg = "#011627"},
        LspTroubleNormal = {fg = "#d6deeb", bg = "#011627"},
        -- Diff
        diffAdded = {fg = c.diff_green},
        diffRemoved = {fg = c.diff_red},
        diffChanged = {fg = c.diff_blue},
        diffOldFile = {fg = "#011627"},
        diffNewFile = {fg = "#d6deeb"},
        diffFile = {fg = "#eeeeee"},
        diffLine = {fg = c.cyan},
        diffIndexLine = {fg = c.purple},
        -- Neogit
        NeogitBranch = {fg = "#eeeeee"},
        NeogitRemote = {fg = c.purple},
        NeogitHunkHeader = {fg = "#d6deeb", bg = c.cyan},
        NeogitHunkHeaderHighlight = {fg = c.blue},
        NeogitDiffContextHighlight = {fg = "#d6deeb"},
        ...
        NvimTreeNormal = {fg = c.light_blue, bg = "#011627"},
        ...
        NvimTreeEmptyFolderName = {fg = "#eeeeee"},
        NvimTreeFolderIcon = {fg = c.blue},
        NvimTreeIndentMarker = {fg = "#eeeeee"},
        LspDiagnosticsError = {fg = c.red},
        LspDiagnosticsWarning = {fg = c.orange},
        LspDiagnosticsInformation = {fg = "#eeeeee"},
        ...
        WhichKeyFloating = {bg = "#011627"},
        WhichKeyFloat = {bg = "#011627"},
        -- LspSaga
        DiagnosticError = {fg = c.red},
        DiagnosticWarning = {fg = c.orange},
        DiagnosticInformation = {fg = c.blue},
        DiagnosticHint = {fg = c.cyan},
        DiagnosticTruncateLine = {fg = "#d6deeb"},
        LspFloatWinNormal = {bg = "#011627"},
        LspFloatWinBorder = {fg = c.purple},
        LspSagaBorderTitle = {fg = c.cyan},
        LspSagaHoverBorder = {fg = "#eeeeee"},
        LspSagaRenameBorder = {fg = c.green},
        LspSagaDefPreviewBorder = {fg = c.green},
        LspSagaCodeActionBorder = {fg = c.blue},
        LspSagaFinderSelection = {fg = c.green},
        LspSagaCodeActionTitle = {fg = "#eeeeee"},
        ...
        BufferLineFill = {bg = "#011627"},
        -- Sneak
        Sneak = {fg = "#011627", bg = c.green},
        SneakScope = {bg = "#011627"},
        -- Indent Blankline
        ...
        -- EasyMotion
        EasyMotionTarget = {fg = c.red, bg = "NONE", style = "bold"},
        EasyMotionTarget2First = {fg = c.red, bg = "NONE", style = "bold"},
        EasyMotionTarget2Second = {fg = c.red, bg = "NONE", style = "bold"},
        -- CoC
        ...
        CocExplorerFileHidden = {fg = "#eeeeee"},
