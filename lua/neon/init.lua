...
local function set_groups()
    local groups = {
        ...
        LspReferenceText =  {style = 'reverse'}, -- used for highlighting "text" references
        LspReferenceRead =  {style = 'reverse'}, -- used for highlighting "read" references
        LspReferenceWrite = {style = 'reverse'}, -- used for highlighting "write" references
