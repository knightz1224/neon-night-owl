...
local function set_groups()
    local groups = {
        ...
        VisualInDiff = {bg = c.regal_blue, fg = c.white },
        VisualNOS = {bg = c.regal_blue, fg = c.white, style = "reverse"},
        ...
        LspReferenceText =  {bg = c.deep_blue, style = "bold"}, -- used for highlighting "text" references
        LspReferenceRead =  {bg = c.deep_blue, style = "bold"}, -- used for highlighting "read" references
        LspReferenceWrite = {bg = c.deep_blue, style = "bold"}, -- used for highlighting "write" references
